<html>
	...
	<body>
		...
		<table class="test"  style="margin-left:auto;margin-right:auto;">
				<tr>
			<?php $counter = 0; foreach ($data['sites'] as $site) {  $counter++;?>
				 <td>
				<div class="flip-card">
  					<div class="flip-card-inner">
    					<div class="flip-card-back">
    						<a href=/customer/viewSite/<?php echo $site->site_id; ?>><button type="button" id="btnSubmit" style="margin-top: 120px;" >VIEW SITE</button></a>
      						
    					</div>
    				<div class="flip-card-front">
    					<h3><?php echo $site->site_name ?></h3>
      					<h3>Address: <?php echo $site->site_address?></h3>
      					<p><b>Email:</b> <?php echo $site->site_email ?></p>
      					<p><b>Phone: </b><?php echo $site->site_phone_number ?></p>
    					</div>
  					</div>
				</div>
			</td>
