            ...
            <?php foreach(array_chunk($data['schedule'] , 2) as $val) {  ?>
                ...
                <div class="container left">
                  <div class="content">
                    ...
                    <p><b> Employee: </b> <?php echo $this->model('Employee')->getEmployee($val[0]->employee_id)->employee_first_name . ' ' . $this->model('Employee')->getEmployee($val[0]->employee_id)->employee_last_name ?> </p>
                ...
                <div class="container right">
                  <div class="content">
                    ...
                    <p><b> Employee: </b> <?php echo $this->model('Employee')->getEmployee($val[1]->employee_id)->employee_first_name . ' ' . $this->model('Employee')->getEmployee($val[1]->employee_id)->employee_last_name ?> </p>
