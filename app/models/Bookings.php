<?php
	...
	class Bookings extends Model{
    	...
    	public function insert(){
	    	$sql = 'INSERT INTO Bookings(employee_id, site_id, customer_id, booking_date, start_time, end_time, status, message) VALUES(:employee_id, :site_id, :customer_id, :booking_date, :start_time, :end_time, :status, :message)';
	        $stmt = self::$_connection->prepare($sql);
	        $stmt->execute(['employee_id'=>$this->employee_id,'site_id'=>$this->site_id, 'customer_id'=>$this->customer_id, 'booking_date'=>$this->booking_date, 'start_time'=>$this->start_time, 'end_time'=>$this->end_time, 'status'=>$this->status, 'message'=>$this->message]);
